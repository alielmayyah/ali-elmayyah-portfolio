          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              ...
              <p className="text-zinc-400 leading-relaxed">
                I am Ali Elmayyah, a Full-Stack Software Engineer based in Cairo, Egypt, with experience building and maintaining web applications and scalable digital solutions.
              </p>
              <p className="text-zinc-400 leading-relaxed">
                I work across front-end and back-end development, API integrations, authentication flows, databases, and responsive interfaces, with a focus on React, TypeScript, Node.js, Express.js, MongoDB, and MySQL.
              </p>
              <p className="text-zinc-400 leading-relaxed">
                My background in graphics design and photography helps me approach software with both technical precision and strong visual judgment, turning complex ideas into clear, useful products.
              </p>
            </div>
              ...
              <div className="glass-panel p-6 rounded-2xl relative overflow-hidden group hover:border-blue-500/50 transition-colors">
                ...
                <div className="space-y-2 mt-4 pt-4 border-t border-zinc-800">
                  <p className="text-zinc-300">
                    <span className="font-semibold text-zinc-400">GPA:</span> 3.09 / 4.0
                  </p>
                  <p className="text-zinc-300">
